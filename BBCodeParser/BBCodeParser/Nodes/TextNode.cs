	...
	public class TextNode : Node
	{
	    ...
	    private static string SubstituteText(string text, Dictionary<string, string> substitutions)
	    {
            return substitutions == null
                ? text
                : substitutions.Aggregate(text, (current, substitution) => current.Replace(substitution.Key, substitution.Value));
	    }
	    ...
	    public override string ToBb(Dictionary<string, string> securitySubstitutions = null)
	    {
